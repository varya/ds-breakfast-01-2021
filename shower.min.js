 ...
 * @shower/core v3.0.0-0, https://github.com/shower/core
...
(function () {
    ...
    var next = shower => {
        const { stepSelector, activeSlideClass, currentSlideClass } = shower.options;
        ...
        const toggleActive = () => {
            innerSteps.forEach((step, index) => {
                ...
                step.classList.toggle(currentSlideClass, index === innerAt -1);
            });
        };
