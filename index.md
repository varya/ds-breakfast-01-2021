...
markdown files for Styleguidist can be generated automatically. And after that, we simply run
...
I think that React can help us here. By using tools from its ecosystem, wuch as Styleguidist, we offer the team a
development playground and autogenerated documentation. It is much easier for people to contribute into a library if
everything is smooth. By using the tools you can offer coding designers a friendly environment and so close the gap
